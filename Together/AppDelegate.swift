...
//
    ...
    func letsgo() {
       ...
       var intselectedsub = Int(selectedsubs)!
   
        intselectedsub = intselectedsub + 1
       selectedsubs = String(intselectedsub)
    ref?.child("Influencers").child(selectedid).updateChildValues(["Subscribers" : selectedsubs])
